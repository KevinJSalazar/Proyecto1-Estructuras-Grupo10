...
public class App extends Application {
    ...
    public static void main(String[] args) {
        ...
        String filePath2 = "vehiculos.ser";
        ...
        // Verifica si el archivo existe
        if (file2.exists()) {
            System.out.println("El archivo vehiculos.ser existe en la ubicación especificada.");
        } else {
            System.out.println("El archivo vehiculos.ser no existe en la ubicación especificada.");
        }
        launch();
    }
